...
<html lang="en">
  ...
  <body>
    ...
    <div class="bolt">
      <a href="http://localhost:7474/browser/" title="Open Neo4j browser"><img src="etc/neo4j-logo-2015.png" /></a>
      <span>MATCH (p:Person {user: "${html_person}"})-[]->(m) RETURN * </span>
    </div>
    ...
    <script src="libs/neovis.js"></script>
